...
public class CameraControll : MonoBehaviour
{
    ...
    public float m_MinSize = 1.0f;                  // The smallest orthographic size the camera can be.
    [HideInInspector] public float requiredSize;
    ...
    private Vector2 m_DesiredPosition;              // The position the camera is moving towards.
    ...
    public void FindAveragePosition()
    {
        ...
        for (int i = 0; i < m_Targets.Length; i++)
        {
            ...
            averagePos += new Vector2(m_Targets[i].position.x, m_Targets[i].position.y);
            numTargets++;
        }
